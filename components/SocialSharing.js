  ...
  return (
    <div className={styles['share-buttons']}>
      {buttons.map(({ id, name, icon, url }) => (
        ...
        >
          <div className={classNames(styles['share-button'], styles[`share-button--${id}`])}>
            <div
              aria-hidden='true'
              className={classNames(styles['share-button__icon'], styles['share-button__icon--solid'])}
            >
      ...
      <CopyToClipboard text={sketchplanationUrl} onCopy={onCopy}>
        <button className={styles['share-button__link']} aria-label='Copy link'>
          <div className={classNames(styles['share-button'], styles['share-button--copylink'])}>
            <div
              aria-hidden='true'
              className={classNames(styles['share-button__icon'], styles['share-button__icon--solid'])}
            >
