...
const Nav = () => (
  <nav
    aria-label='Footer'
    className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 lg:text-center gap-x-12 gap-y-2 items-start max-w-screen-xl mx-auto'
  >
  ...
  return (
    <footer className={styles.root}>
      <div className={styles.content}>
          ...
          <div id='footer-categories' className='pt-6 sm:pt-10 px-[var(--edgeInset)]'>
            <div className='max-w-screen-xl mx-auto'>
              ...
              <div className='prose mb-6'>
                <p className='text-balance'>The sketches cover many topics. Here are some of my favourites:</p>
              </div>
              ...
              <FancyLink href='/categories' className='inline-block hover:text-blue mt-6'>
        ...
        <div
          id='footer-subscribe-inline'
          className={`${isHome ? '' : 'border-t border-borderFooter '}pt-6 sm:pt-10 px-[var(--edgeInset)]`}
        >
        ...
        <div className='text-center text-sm px-[var(--edgeInset)] py-4'>
          When you buy through links on sketchplanations.com, I may earn an affiliate commission. Thanks for supporting
          the site!
        </div>
