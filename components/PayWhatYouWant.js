        ...
        {free || paymentIntent ? (
          ...
          <>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <div>
                <button className={styles['pay-button']} type='submit' disabled={processing || !stripe}>
                  {processing ? 'Processing…' : 'Pay and download'}
                </button>
                <button className={styles['free-button']} type='button' onClick={() => setFree(true)}>
                  Download for free
                </button>
              </div>
            </form>
            <div className={styles.footer}>
              ...
              <a href='https://stripe.com/' rel='noreferrer' target='_blank'>
                <svg className={styles['powered-by-stripe']} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 150 34'>
