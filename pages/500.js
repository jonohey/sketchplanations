    ...
    <div className='root'>
      <div className='content'>
        ...
        <p className='help-text text-center mx-auto mt-1 px-10'>
          Something broke. Sorry! Maybe <a href='/search'>search Sketchplanations</a> or try looking in <a href='/tags'>tags</a>?
        </p>
        <p className='help-text text-center mx-auto mt-1 px-10'>
          Please let me know this page is broken so I can fix it. I’m at{' '}
